...
void main()
{
	...
	if(billBoarded > 0){
		...
		vec3 vertexPosition_worldspace = vec3(position.x, position.y, 1.0f);
		gl_Position = projectionMatrix * viewMatrix * modelMatrix * vec4(vertexPosition_worldspace, 1.0);
	}
